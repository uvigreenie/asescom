...
(function () {
    ...
    Ext.apply(UtilFormat, {
        ...
        */
        ...
        fnColorearPorcentajeTexto: function (value) {
...
//            return formatFn(v);
            ...
            if (v > 0) {
                return '<span style="color:red;font-weight: bold;">' + formatFn(v) + '</span>';
            } else if (v < 0) {
                return '<span style="color:green;">' + formatFn(v) +'</span>';
            }
            return formatFn(v);
        },

        fnColorearPorcentaje: function (v) {
            var formatString = "0,000.00";
            ...
            if (v > 0) {
                return '<span style="color:green;font-weight: bold;">' + formatFn(v) + ' %</span>';
            } else if (v < 0) {
                return '<span style="color:green;">' + formatFn(v) + '</span>';
            }
            return formatFn(v);
